...
For a step-by-step Chinese guide, use `docs/manual-test-guide-zh.md`. For the final account-flow checks, use `docs/final-account-qa-zh.md`. For the production upload tracker, use `docs/launch-readiness.md`.
