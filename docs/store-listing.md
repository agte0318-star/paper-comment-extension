...
- Detects arXiv IDs, PubMed IDs, PMC IDs, and DOI-based paper pages across a broader SCI publisher and journal allowlist, including Wiley journal subdomains, SciOpen, and Science China platforms.
